...
jQuery.fn.fixedtableheader = function(options) { 
	...
	this.each(function(i) { 
		var $tbl = $(this); 
		var $tblhfixed = $tbl.find("thead:lt(" + settings.headerrowsize + ")"); 
		...
		if ($tblhfixed.find(headerelement).length > 0) { 
			...
			$clonedTable.attr("id", "fixedtableheader" + i).css(
				{ "position": "fixed", "z-index": "1000", "top": "0", "left": $tbl.offset().left }
				).append($tblhfixed.clone()).width(tblwidth).hide().appendTo($("#outerRight")); 
			...
			$(window).scroll(function() { 
					if (jQuery.browser.msie && jQuery.browser.version == "6.0") 
						$clonedTable.css({ "position": "absolute", "z-index":"1", "top": $(window).scrollTop(), "left": $tbl.offset().left }); 
					else 
						$clonedTable.css({ "position": "fixed", "z-index":"1000", "top": "0", "left": $tbl.offset().left - $(window).scrollLeft()}); 
